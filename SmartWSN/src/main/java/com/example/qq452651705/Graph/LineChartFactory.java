package com.example.qq452651705.Graph;
...
import static com.example.qq452651705.Sensor.SensorData.FORMAT_WIND;
import static com.example.qq452651705.Sensor.SensorData.FORMAT_FANSPEED;
import static com.example.qq452651705.Sensor.SensorData.FORMAT_HUMIDITY;
import static com.example.qq452651705.Sensor.SensorData.FORMAT_LIGHT;
import static com.example.qq452651705.Sensor.SensorData.FORMAT_TEMPERATURE;
...
public class LineChartFactory {
    ...
    public final static int CHART_WIND = 2;
    ...
    static {
        ...
        ChartNameMap.put("风速风向监测", CHART_WIND);
...
//        ChartNameMap.put("风扇监测",CHART_FANSPEED);
        ...
        sensorChartMapArrayList.add(new SensorChartMap(SENSOR_WIND,new Integer[]{CHART_WIND}));
...
//        sensorChartMapArrayList.add(new SensorChartMap(SENSOR_FAN,new Integer[]{CHART_FANSPEED}));
        ...
        chartSensorMapArrayList.add(new ChartSensorMap(CHART_WIND,new Integer[]{SENSOR_WIND}));
...
//        chartSensorMapArrayList.add(new ChartSensorMap(CHART_FANSPEED,new Integer[]{SENSOR_FAN}));
        ...
        ChartLineChartFactoryMap.put(CHART_WIND,null);
...
//        ChartLineChartFactoryMap.put(CHART_FANSPEED,null);
        ...
        SensorColorMap.put(SENSOR_WIND,Color.parseColor("#F4D313"));
...
//    }
     ...
     *  查询指定图表中包含的所有传感器ID
     */
    public static Integer[] getSensorListInChart(int chartID){
    ...
    private YAxis leftYAxisProcessor(int chartID) {
        ...
        }else if(CHART_WIND ==chartID){
            axisLeft.setValueFormatter(new MyYAxisValueFormatter(sensorData.FORMAT_WIND));
            axisLeft.setDrawGridLines(false);
    ...
    private YAxis rightYAxisProcessor(int chartID) {
        ...
        if (CHART_TEMPERATURE_AND_HUMIDITY == chartID) {
            ...
            axisRight.setAxisMinimum(0);
            axisRight.setAxisMaximum(100);
            axisRight.setValueFormatter(new MyYAxisValueFormatter(sensorData.FORMAT_WIND));
            axisRight.setDrawGridLines(false);
        }else if(CHART_LIGHT==chartID){
            axisRight.setDrawLabels(false);
    ...
    private LineDataSet lineDataSetProcessor(Integer sensorID, LineDataSet lineDataSet) {
        ...
        }  else if (SENSOR_WIND ==sensorID) {
            lineDataSet.setAxisDependency(YAxis.AxisDependency.LEFT);
            lineDataSet.setColor(SensorColorMap.get(SENSOR_WIND));
            lineDataSet.setCircleColor(SensorColorMap.get(SENSOR_WIND));
            lineDataSet.setCircleColorHole(Color.parseColor("#FFF68F"));
            lineDataSet.setFillColor(Color.parseColor("#FFF68F"));
            lineDataSet.setValueFormatter(new MyValueFormatter(sensorData.FORMAT_WIND));
        ...
        public String getFormattedValue(float value, Entry entry, int dataSetIndex, ViewPortHandler viewPortHandler) {
            ...
            switch (formatter) {
                ...
                case FORMAT_HUMIDITY:
                    ...
                    break;
                case FORMAT_WIND:
                    format = mFormat.format(value) + "m/s";
                    break;
                case FORMAT_LIGHT:
