package com.example.qq452651705.SharedPreferences;
...
public class Config {
    ...
    private final String CONFIG_USERNAME="USERNAME";
    ...
    public void setCookies(String cookies){
        editor.putString(CONFIG_COOKIES, cookies);
        editor.apply();
    }
    public String getCookies(){return config.getString(CONFIG_COOKIES,"");}
